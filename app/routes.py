...
from app.forms import RegisterForm,LoginForm,SpellCheckerForm,AdminHistoryForm,UserLogsForm
...
def home():
    ...
    if form.validate_on_submit():
        ...
        with open("app/words.txt", 'w') as f:
            f.write(sentence)
        cmd = "./app/spell_check app/words.txt app/wordlist.txt"
